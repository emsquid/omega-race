...
const deroule_sous_classe = (obj, liste) => {
...
object1.onclick = () => {
    deroule_sous_classe(object1, liste1)
}
object1_1.onclick = () => {
    deroule_sous_classe(object1_1, liste1_1)
}
object1_1_1.onclick = () => {
    deroule_sous_classe(object1_1_1, liste1_1_1)
}
object1_1_2.onclick = () => {
    deroule_sous_classe(object1_1_2, liste1_1_2)
}
object2.onclick = () => {
    deroule_sous_classe(object2, liste2)
}
